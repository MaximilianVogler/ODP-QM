...
tau0_vec_tr = linspace(-0.9,-0.8,10)';
taubar_vec_tr = linspace(-0.9,-0.8,10)';
gal_vec_tr = [0];

% Vectors of parameters for optimal tax schedule
tax_vec_ss = linspace(-0.4,-0.3,20)'; %Testing for optimal steady state tax

tau0_vec = linspace(-0.3,-0.2,10)'; %Initial tax rate
taubar_vec = linspace(-0.9,-0.8,10)'; %Final tax rate
halflives_vec = [1 2 3];%[5 7 10]; %Tax schedule half life
